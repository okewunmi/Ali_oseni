...
const Index = () => {
  ...
  return (
    <Fade duration={500} distance="30px" delay={500}>
        ...
        <Wrapper
          style={{
            background: isDarkMode ? "#1C2540" : "#fff",
        ...
        >
          ...
          <Content>
            ...
            <div className="image">
              <Image src="/stalker.png" alt="img" width={740} height={992} />
            </div>
            <article className="cont">
              <h1>Stackwalker LLC</h1>
              <p>
                Stackwalker LLC is a provider of custom web, cloud, mobile,
                digital, and desktop software development and consulting
                services to clients in every industry from hot startups to
                Fortune 500 companies. We also offer Devops Services and
                Consulting, Cloud and Infrastructure development and migration
                services.
              </p>
