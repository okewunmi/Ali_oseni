    ...
    return (
        ...
        <NavBar style={{background:darkMode? "#1C2540":"#EBF4F6", color:darkMode? '#ffff': "#171F38"}} >  
            ...
            <Content>
                ...
                <div className='image'>
                    <Image src='/nexterV.png' alt='img' width={740} height={992} />
                </div>
                <article className='cont'>
                    <h1>Nester Verify</h1>
                    <p>This service enables business verification for businesses in Nigeria. This validates business details such as, Business name, registration number, physical address confirmation with pictures,The number of shares owned by the stakeholders, list of shareholders and many more.</p>
