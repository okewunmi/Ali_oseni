      ...
      <Link href="/project">
        ...
        >
          ...
          <Content>
            ...
            <div className="image">
              <Image src="/zeed.png" alt="img" width={740} height={992} />
            </div>
            <article className="cont">
              <h1>Zeedas Presentation</h1>
              <p>
                Zeedas Hire is a platform that gives you unlimited access to
                talented software developement teams across the globe.
              </p>
