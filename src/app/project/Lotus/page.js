...
const toggleMenu=()=>{
    ...
    return (
        ...
        <Wrapper style={{background:darkMode? "#1C2540":"#ffff", color:darkMode? '#ffff': "#171F38"}}>
        <NavBar style={{background:darkMode? "#1C2540":"#EBF4F6", color:darkMode? '#ffff': "#171F38"}} >  
            ...
            <Content>
                ...
                <div className='image'>
                    <Image src='/stackWalker.png' alt='img' width={740} height={992} />
                </div>
                <article className='cont'>
                    <h1>Lotus Capital App</h1>
                    <p>Lotus Capital Limited is a full-service ethical investment management company specializing in Asset Management, Private Wealth Management, and Financial Advisory services.
Lotus Capital is a pioneer in non-interest finance in Nigeria and duly registered with the Securities & Exchange Commission (SEC) as Fund Managers. </p>
