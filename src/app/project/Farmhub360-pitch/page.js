...
const Index = () => {
    ...
    return (
        ...
        <Wrapper style={{background:darkMode? "#020D1A":"#ffff", color:darkMode? '#ffff': "#020A13"}}>
        <NavBar style={{background:darkMode? "#1C2540":"#EBF4F6", color:darkMode? '#ffff': "#171F38"}} >  
            ...
            <Content>
                ...
                <article className='cont'>
                    ...
                    <p>Farmhub360 is an e-commerce platform where buying and selling of farm produce take place, such as crops, livestock, food processes, seafoods, vegetables, buying farm machines and exportation of agro commodities</p>
