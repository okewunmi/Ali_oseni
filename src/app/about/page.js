...
const Index = () => {
  // const {darkMode} =useTheme();
    return (
        <Wrapper>
        <Nav/>
        {/* <section className="timeline" style={{background:darkMode? "#1C2540":"#EBF4F6", color:darkMode? '#ffff': "#171F38"}}> */}
        <section className="timeline" >
            ...
            <ol className="timeline-list">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">The Design of Everyday Things</h4>
                </div>
