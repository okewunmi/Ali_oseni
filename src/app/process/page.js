        ...
        <section >
            ...
            <ol className="timeline-list">
              ...
              <li className="timeline-item">
                ...
                <p className="timeline-text">Organize the content and layout of the product, ensuring logical navigation and a clear hierarchy.</p>
              </li>
            ...
            <li className="timeline-item">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">Development Collaboration</h4>
                </div>
                <p className="timeline-text">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">Quality Assurance (QA)</h4>
                </div>
                <p className="timeline-text">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">User Interface Testing</h4>
                </div>
                <p className="timeline-text">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">Feedback and Iteration</h4>
                </div>
                <p className="timeline-text">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">Launch and Deployment</h4>
                </div>
                <p className="timeline-text">
              ...
              <li className="timeline-item">
              <div className='head'> 
              <h4 className="h4 timeline-item-title">The UI/UX design process is dynamic and iterative, with a strong focus on user needs and continuous improvement. Each project may involve variations in these steps, depending on the scope and goals, but we following this general process to helps us ensure a well-rounded design outcome.</h4>
                </div>
                {/* <p className="timeline-text">
                Evaluate the design's success based on predefined metrics and key performance indicators. Identify areas for improvement in future iterations.
                </p> */}
