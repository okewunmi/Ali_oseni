    ...
    return (
        <Wrapper style={{background:darkMode? "#020A13":"#ffff", color:darkMode? '#ffff': "#020A13"}}>
            ...
            <div className='header__txt'  >
               ...
               <h1 style={{background:darkMode? "#020A13":"#ffff", color:darkMode? '#EBF4F6': "#020A13"}}>Hello, I’m <span> <strike>Oseni Ali Abayomi</strike> </span></h1>
            ...
            <div className='header__bring'>
                <h1 className='header__bring__head' style={{ color:darkMode? '#EBF4F6': "#111111"}}>What I Bring to Your Team</h1>
                ...
                <div className='header__bring__box' >
                    ...
                    <div className='header__bring__box--container box__2'  style={{background:darkMode? "#03172D":"#EBF4F6", color:darkMode? '#EBF4F6': "#111111"}}>
                        ...
                        <p style={{ color:darkMode? '#EEEEEE': "#111111"}}>I am well-versed in industry-standard design tools and
                    ...
                    <div className='header__bring__box--container box__1' style={{background:darkMode? "#020D1A":"#EEEEEE", color:darkMode? '#EBF4F6': "#111111"}}>
                        ...
                        <p style={{ color:darkMode? '#EEEEEE': "#111111"}}>I constantly strive to think outside the box, infusing my
                    ...
                    <div className='header__bring__box--container box__2' style={{background:darkMode? "#03172D":"#EBF4F6", color:darkMode? '#03172D': "#111111"}}>
                        ...
                        <p style={{ color:darkMode? '#EEEEEE': "#111111"}}>I am a proactive communicator who values constructive
                    ...
                    <div className='header__bring__box--container box__1' style={{background:darkMode? "#020D1A":"#EEEEEE", color:darkMode? '#EBF4F6': "#111111"}}>
                        ...
                        <p style={{ color:darkMode? '#EEEEEE': "#111111"}}>I approach challenges with a growth mindset,
                    ...
                    <div className='header__bring__box--container box__2' style={{background:darkMode? "#03172D":"#EBF4F6", color:darkMode? '#03172D': "#111111"}}>
                        ...
                        <p style={{ color:darkMode? '#EEEEEE': "#111111"}}>This commitment to excellence results in polished and
            ...
            <h1 className='header__skill__head'>Skills</h1>
                ...
                <div className='header__skill__box'  >
                    <div className='txt'>
                        <h3 style={{ color:darkMode? '#ffff': "#1C2540"}}>Design</h3>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Product Design</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>UX Design</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Visual Design (UI)</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Wire-framing + Prototyping</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Journey-Mapping</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>UX Research</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Logo and Branding</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Creative Direction</p>

                    </div>
                    <div className='txt'>
                        <h3 style={{ color:darkMode? '#ffff': "#1C2540"}}>Software</h3>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Postman</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Sketch</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Adobe Illustrator</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Adobe Photoshop</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Figma</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>InVision</p>
                    </div>
                    <div className='txt'>
                        <h3 style={{ color:darkMode? '#ffff': "#1C2540"}}>Development</h3>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>HTML</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>SASS + CSS</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Javascript + jQuery</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}} >ReactJS</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>API Integrations</p>
                        <p style={{ color:darkMode? '#ffff': "#58677D"}}>Working within SDKsg</p>
            ...
            <h1 className='header__ux__head'>Experience</h1>
                ...
                <div className='header__exp__box'>
                    <div className='container' style={{background:darkMode? "#020A13":"#ffff", color:darkMode? '#ffff': "#020A13"}}>
                        ...
                        <p className='content-txt' style={{ color:darkMode? '#ffff': "#1C2540"}}>Collaborate with creative and development teams on the execution of ideas.</p>
                        </div>
                        <div className='date'>
                            <p>2027 - 2018</p></div>
                    </div>
